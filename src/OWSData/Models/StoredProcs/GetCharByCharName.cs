...
namespace OWSData.Models.StoredProcs
{
    public class GetCharByCharName
    {
        ...
        public double Smelting { get; set; }
        public double Smithing { get; set; }
        public double Cooking { get; set; }
        public double Fletching { get; set; }
        public double Tailoring { get; set; }
        public double Hunting { get; set; }
        public double Leatherworking { get; set; }
        public double Farming { get; set; }
        public double Herblore { get; set; }
