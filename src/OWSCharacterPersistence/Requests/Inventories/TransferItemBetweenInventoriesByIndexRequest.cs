...
/// Transfer Item Between Inventories
/// </remarks>
public class TransferItemBetweenInventoriesByIndexRequest
{
    /// <summary>
    ...
    public async Task<TransferItemResult> Handle()
    {
        ...
        output = await charactersRepository.TransferItemBetweenInventories(customerGUID, SourceCharacterInventoryID, TargetCharacterInventoryID, ItemQuantity, SourceSlotIndex, TargetSlotIndex);
