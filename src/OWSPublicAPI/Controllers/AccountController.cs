...
using OWSPublicAPI.Requests.Account;
...
namespace OWSPublicAPI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> CreateCharacter([FromBody] CreateCharacterRequest request)
        {
            ...
            request.SetData(_accountRepository, _publicAPIInputValidation, _customerGuid);
        ...
        public async Task<SuccessAndErrorMessage> CreateCharacterUsingDefaultCharacterValues([FromBody] CreateCharacterUsingDefaultCharacterValuesDTO createCharacterUsingDefaultCharacterValuesDTO)
        {
            CreateCharacterUsingDefaultCharacterValuesRequest request = 
                new CreateCharacterUsingDefaultCharacterValuesRequest(createCharacterUsingDefaultCharacterValuesDTO, _accountRepository, _charactersRepository, _publicAPIInputValidation, _customerGuid);
            return await request.Handle();
        }
        ...
        {
            request.SetData(_accountRepository, _customerGuid);
            return await request.Handle();
        }
        ...
        {
            request.SetData(_owsGeneralConfig, _accountRepository, _charactersRepository, _customerGuid, _httpClientFactory);
            return await request.Handle();
        }
        ...
        /// </remarks>
        [HttpGet]
        [Route("GetAccountSession")]
        [Produces(typeof(GetAccountSession))]
        public async Task<IActionResult> GetAccountSession([FromQuery] GetAccountSessionRequest request)
        {
            request.SetData(_accountRepository, _customerGuid);
            return await request.Handle();
        }
        ...
        {
            request.SetData(_accountRepository, _externalLoginProviderFactory, _customerGuid);
            return await request.Handle();
        }
        ...
        {
            LogoutRequest logoutRequest = new LogoutRequest(request, _accountRepository, _customerGuid);
        ...
        /// </remarks>
        [HttpPost]
        [Route("AccountSessionSetSelectedCharacter")]
        [Produces(typeof(SuccessAndErrorMessage))]
        public async Task<IActionResult> AccountSessionSetSelectedCharacter([FromBody] AccountSessionSetSelectedCharacterRequest request)
        {
            request.SetData(_accountRepository, _customerGuid);
            return await request.Handle();
        }
        ...
        /// </summary>
        [HttpPost]
        [Route("SetSelectedCharacterAndGetAccountSession")]
        [Produces(typeof(GetAccountSession))]
        public async Task<IActionResult> SetSelectedCharacterAndGetAccountSession([FromBody] SetSelectedCharacterAndGetAccountSessionRequest request)
        {
            request.SetData(_accountRepository, _customerGuid);
            return await request.Handle();
        }
        ...
        [Produces(typeof(PlayerLoginAndCreateSession))]
        public async Task<PlayerLoginAndCreateSession> RegisterAccount([FromBody] RegisterAccountDTO requestDTO)
        {
            RegisterAccountRequest request = new RegisterAccountRequest(requestDTO, _accountRepository, _externalLoginProviderFactory, _customerGuid);
            return await request.Handle();
        }
