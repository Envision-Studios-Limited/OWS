...
namespace OWSPublicAPI.Requests.Account
{
    ...
    public class ExternalLoginAndCreateSessionRequest : IRequestHandler<ExternalLoginAndCreateSessionRequest, IActionResult>, IRequest
    {
        ...
        /// </remarks>
        public void SetData(IAccountRepository accountRepository, IExternalLoginProviderFactory externalLoginProviderFactory, IHeaderCustomerGUID customerGuid)
        {
        ...
        public async Task<IActionResult> Handle()
        {
            ...
            {
                //Login to OWS
                output = await accountRepository.LoginAndCreateSession(customerGUID, Email, Password);
            ...
            */
            ...
            _output.AccountSessionGuid = Guid.Empty;
