...
namespace OWSPublicAPI.Requests.Account
{
    public class GetServerToConnectToRequest : IRequestHandler<GetServerToConnectToRequest, IActionResult>, IRequest
    {
        ...
        public void SetData(IOptions<PublicAPIOptions> owsGeneralConfig, IAccountRepository accountRepository, ICharactersRepository charactersRepository, IHeaderCustomerGUID customerGuid, IHttpClientFactory httpClientFactory)
        {
